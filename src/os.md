...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是操作系统)什么是操作系统？

可以这么说，操作系统是一种运行在内核态的软件。

它是应用程序和硬件之间的媒介，向应用程序提供硬件的抽象，以及管理硬件资源。

![操作系统是什么](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-be55aec1-e7ab-433f-97f1-14d99960b6bf.png)操作系统是什么

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#操作系统主要有哪些功能)操作系统主要有哪些功能？
...
![操作系统主要功能](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-eee82952-c96f-45c9-835e-29db37c0f6d8.png)操作系统主要功能
...
## [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#操作系统结构)操作系统结构

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是内核)什么是内核？

可以这么说，内核是一个计算机程序，它是操作系统的核心，提供了操作系统最核心的能力，可以控制操作系统中所有的内容。

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是用户态和内核态)什么是用户态和内核态？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#用户态和内核态是如何切换的)用户态和内核态是如何切换的？

应⽤程序如果需要进⼊内核空间，就需要通过系统调⽤，来进入内核态：

![用户态&内核态切换](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-b358cdae-18b6-45d4-8a5b-4ea3a7cfc273.png)用户态&内核态切换
...
## [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#进程和线程)进程和线程

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#并行和并发有什么区别)并行和并发有什么区别？
...
![并发和并行](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-fb7891d8-8330-494b-9bc1-cf829b5cc82d.png)并发和并行

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是进程上下文切换)什么是进程上下文切换？
...
![进程上下文切换-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-187d1cf9-971d-4395-b888-5e6eaf2be5f1.png)进程上下文切换-来源参考[3]

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#进程有哪些状态)进程有哪些状态？
...
![进程5种状态](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-ae17a9dc-f555-481a-ba4a-caca06120be7.png)进程5种状态

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是僵尸进程)什么是僵尸进程？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是孤儿进程)什么是孤儿进程？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#进程有哪些调度算法)进程有哪些调度算法？

进程调度就是确定某一个时刻CPU运行哪个进程，常见的进程调度算法有：

![进程调度算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-18911b0a-7326-467f-94fb-8c01a6980578.png)进程调度算法
...
![先来先服务](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-93088d03-80c9-46c5-9eaf-eead2adb6e12.png)先来先服务

- **短作业优先**

非抢占式的调度算法，按估计运行时间最短的顺序进行调度。长作业有可能会饿死，处于一直等待短作业执行完毕的状态。因为如果一直有短作业到来，那么长作业永远得不到调度。

![短作业优先](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-517e8392-64fe-4de3-9e1c-b3a944822aba.png)短作业优先

- **优先级调度**

为每个进程分配一个优先级，按优先级进行调度。为了防止低优先级的进程永远等不到调度，可以随着时间的推移增加等待进程的优先级。

![优先级调度](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-7c4441cf-7b8c-4660-8ba8-29b8076e2da1.png)优先级调度
...
![时间片轮转](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-ad224c3a-8ac9-4230-84e4-ec434d5b49f9.png)时间片轮转

- **最短剩余时间优先**

最短作业优先的抢占式版本，按剩余运行时间的顺序进行调度。 当一个新的作业到达时，其整个运行时间与当前进程的剩余时间作比较。如果新的进程需要的时间更少，则挂起当前进程，运行新的进程。否则新的进程等待。

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#进程间通信有哪些方式)进程间通信有哪些方式？

![进程间通信方式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-34b8635f-ec27-46c6-87c3-91440fea662d.png)进程间通信方式
...
- 管道：管道可以理解成不同进程之间的对白，一方发声，一方接收，声音的介质可是是空气或者电缆，进程之间就可以通过管道，**所谓的管道就是内核中的一串缓存**，从管道的一端写入数据，就是缓存在了内核里，另一端读取，也是从内核中读取这段数据。
  ...
  ![“奉先我儿”](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-5994e202-0d59-4a86-8f79-a17a5d0bd3d3.png)“奉先我儿”
...
![消息队列](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-d3d8bef5-ae32-487f-828d-aaddb93867c4.png)消息队列
...
![共享内存](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-d9e3cfaf-01e7-42ff-9290-94ef4a5c7d5e.png)共享内存
...
- 信号量：信号量我们可以理解成红绿灯，红灯行，绿灯停。**它本质上是一个整数计数器**，可以用来控制多个进程对共享资源的访问。它常作为一种锁机制，防止某进程正在访问共享资源时，其他进程也访问该资源。因此，主要作为进程间以及同一进程内不同线程之间的同步手段。
  ...
  ![信号量](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-5fb765af-918c-4037-a3ad-4cad4d985e16.png)信号量
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#进程和线程的联系和区别)进程和线程的联系和区别？
...
![多线程-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-271e450b-66ef-4f6c-b823-8e0b73347825.png)多线程-来源参考[3]
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#线程上下文切换了解吗)线程上下文切换了解吗？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#线程有哪些实现方式)线程有哪些实现方式？
...
![混合线程实现](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-1597d159-1b07-48ae-ac86-7e9b9cb85876.png)混合线程实现

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#线程间如何同步)线程间如何同步？
...
![临界区互斥-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-48a5b48b-2474-4460-ac5b-9502883b353f.png)临界区互斥-来源参考[3]
...
![加锁和解锁-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-4bd37c12-992d-4660-8b63-15c3b35d105f.png)加锁和解锁-来源参考[3]
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是死锁)什么是死锁？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#死锁产生有哪些条件)死锁产生有哪些条件？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#如何避免死锁呢)如何避免死锁呢？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#活锁和饥饿锁了解吗)活锁和饥饿锁了解吗？
...
## [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#内存管理)内存管理

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是虚拟内存)什么是虚拟内存？
...
![虚拟内存](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-ec171cea-0046-4709-a390-7babf3272c49.png)虚拟内存

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是内存分段)什么是内存分段？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是内存分页)什么是内存分页？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#多级页表知道吗)多级页表知道吗？
...
![多级页表示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-3021f22f-b9a3-49d9-9e80-6d3abaf5a61a.png)多级页表示意图

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是块表)什么是块表？
...
![TLB示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-cdc02a2f-59bf-45dc-8531-83b46f77bd65.png)TLB示意图-来源参考[3]

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#分页和分段有什么区别)分页和分段有什么区别？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#什么是交换空间)什么是交换空间？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#页面置换算法有哪些)页面置换算法有哪些？
...
![常见页面置换算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-6effefb6-67d2-4155-a3fc-4b27a319391a.png)常见页面置换算法
...
![按照进入内存早晚构建的页面链表 ](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-8cccc78d-ba25-4c0a-8ee8-0913e80af7b7.png)按照进入内存早晚构建的页面链表
...
![LRU实现](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-90810f7f-aa5b-4626-9761-c2c622b5e561.png)LRU实现
...
![时钟页面置换算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-3646408f-999e-48a1-84e9-113525778aca.png)时钟页面置换算法
...
## [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#文件)文件

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#硬链接和软链接有什么区别)硬链接和软链接有什么区别？

- 硬链接就是在目录下创建一个条目，记录着文件名与 inode 编号，这个 inode 就是源文件的 inode。删除任意一个条目，文件还是存在，只要引用数量不为 0。但是硬链接有限制，它不能跨越文件系统，也不能对目录进行链接。

![硬链接-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-d3f778f9-506b-4b93-9fb7-40eb0a79874e.png)硬链接-来源参考[3]
...
- 软链接相当于重新创建⼀个⽂件，这个⽂件有**独⽴的** **inode**，但是这个**⽂件的内容是另外⼀个⽂件的路径**，所以访问软链接的时候，实际上相当于访问到了另外⼀个⽂件，所以**软链接是可以跨⽂件系统的**，甚⾄**⽬标⽂件被删除了，链接⽂件还是在的，只不过打不开指向的文件了而已。**
  ...
  ![软链接-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-81abf13c-5c60-4263-8fcb-c79c33d865e8.png)软链接-来源参考[3]

## [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#io)IO

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#零拷贝了解吗)零拷贝了解吗？

假如需要文件传输，使用传统I/O，数据读取和写入是用户空间到内核空间来回赋值，而内核空间的数据是通过操作系统的I/O接口从磁盘读取或者写入，这期间发生了多次用户态和内核态的上下文切换，以及多次数据拷贝。

![传统文件传输示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-1e595664-6585-4d56-8939-08b7ce510218.png)传统文件传输示意图-来源参考[3]
...
![mmap示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-6dc49f9d-0bc3-4956-a650-7c7236f234a2.png)mmap示意图-来源参考[3]
...
![sendfile示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-0b087b8a-8d51-4aad-898d-d99c38d36592.png)sendfile示意图-来源参考[3]

很多开源项目如Kafka、RocketMQ都采用了零拷贝技术来提升IO效率。

### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#聊聊阻塞与非阻塞-i-o-、-同步与异步-i-o)聊聊**阻塞与⾮阻塞** **I/O **、 **同步与异步** **I/O**？
...
### [#](https://tobebetterjavaer.com/sidebar/sanfene/os.html#详细讲一讲i-o多路复用)详细讲一讲I/O多路复用？
...
![epoll接口作用-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/os-cca76ac4-cfb4-4374-8fc6-256cd4d3893f.png)epoll接口作用-来源参考[3]
